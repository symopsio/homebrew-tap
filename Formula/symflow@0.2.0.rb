...
class SymflowAT020 < Formula
  ...
  if build.with? "source"
    ...
    if OS.mac?
      url "https://github.com/symopsio/sym-flow-cli-releases/releases/download/v0.2.0/sym-flow-cli-darwin-x64.tar.gz"
      sha256 "90c94438d688e251e1c8b862f86bd335e37bb3a726f53a9412f92f5f9302cab4"
    else
      url "https://github.com/symopsio/sym-flow-cli-releases/releases/download/v0.2.0/sym-flow-cli-linux-x64.tar.gz"
      sha256 "6b6e6459be0624253b5f9f6c4555143a512882ee2cdb55357501119f2716b280"
    end
