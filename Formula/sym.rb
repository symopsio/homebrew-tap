class Sym < Formula
  ...
  if OS.mac?
    url "https://github.com/symopsio/sym-cli-releases/releases/download/v0.1.4a5/sym-cli-darwin-x64.tar.gz"
    sha256 "85caf4d434fe1f15b59a3cdc46dd231fd2e422ae7156fb5ccd4afebf98b31a4d"
    bottle :unneeded
