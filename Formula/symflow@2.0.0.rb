...
class SymflowAT200 < Formula
  ...
  if build.with? "source"
    ...
    url "https://files.pythonhosted.org/packages/ab/d4/60fed737512f707bd605a77490e8fe9ad54c00109987829a30e12d151c64/sym-flow-cli-2.0.0.tar.gz"
    sha256 "72128f39c549ecedb13386d0c172661216957081d23f095690eb54a9bc7a4e8a"
    ...
    resource "auth0-python" do
      url "https://files.pythonhosted.org/packages/51/71/fbd176a8e4f89f96aa273b69a12444b77d80a2f1551b6b449804eb0ac8f0/auth0-python-3.23.1.tar.gz"
      sha256 "b1711683acebc0cb3ca424a5a09b4b2f7a3b6405d34e231712023bb036a882be"
    end
    ...
    resource "boto3" do
      url "https://files.pythonhosted.org/packages/fc/d1/af42af26e3d675db4487e5e1eb3d6456cb210909f65ad0f3020dca84ffbb/boto3-1.24.77.tar.gz"
      sha256 "16646de3303779d6dc9c192d8a863095244de81d2e0b94f50692fbde767c6f1b"
    end

    resource "botocore" do
      url "https://files.pythonhosted.org/packages/cf/5c/8d090a00d903d5259b0016630f82939a3b441b8e4f474d945ec4cb72a88a/botocore-1.27.77.tar.gz"
      sha256 "77a43e970d0762080b4b79a7e00ea572ef2ae7a9f578c3c8e7f0a344ee4b4e6d"
    end
    ...
    if OS.mac?
      url "https://github.com/symopsio/sym-flow-cli-releases/releases/download/v2.0.0/sym-flow-cli-darwin-x64.tar.gz"
      sha256 "47f6512603a507839878f84d1f5636f6bfd2ed993466b5b782897b252021e194"
    else
      url "https://github.com/symopsio/sym-flow-cli-releases/releases/download/v2.0.0/sym-flow-cli-linux-x64.tar.gz"
      sha256 "97b1e3145c39f186037b2c00c9146da9c0ced800538a0dc1f0581df06dd2e7df"
    end
