...
class SymflowAT520-post75+4614bf3 < Formula
  desc "CLI to deploy Sym Flows"
  homepage "https://docs.symops.com"
  version "5.2.0-post.75+4614bf3"
  ...
  if build.with? "source"
    ...
    if OS.mac?
      url "https://github.com/symopsio/sym-flow-cli-releases/releases/download/v5.2.0-post.75+4614bf3/sym-flow-cli-darwin-x64.tar.gz"
      sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5"
    else
      url "https://github.com/symopsio/sym-flow-cli-releases/releases/download/v5.2.0-post.75+4614bf3/sym-flow-cli-linux-x64.tar.gz"
      sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5"
    end
